    ...
    <main className="relative h-full overflow-y-auto bg-brand-background text-brand-on-surface">
      ...
      <div className="container relative max-w-5xl px-6 py-10">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="inline-flex items-center gap-2 rounded-full border border-brand-outline-variant/30 bg-brand-surface-container/60 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-brand-on-surface">
          ...
          <Button
            ...
            className="gap-2 border-brand-outline-variant/30 bg-white/5 text-brand-on-surface transition-all hover:bg-white/10 hover:text-brand-tertiary"
          >
        ...
        {error && (
          <div className="mb-6 flex items-center gap-2 rounded-xl border border-destructive/50 bg-destructive/10 p-4 text-sm text-destructive">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="glass-card rounded-2xl border border-brand-outline-variant/20 bg-brand-surface-container/30 p-6 shadow-xl md:p-8">
              <h3 className="mb-2 flex items-center gap-2 text-xl font-bold text-brand-on-surface">
                <User className="h-5 w-5 text-brand-primary" />
                Cập nhật thông tin tài khoản
              </h3>
              <p className="mb-6 text-xs text-brand-on-surface-variant/80">
              ...
              <form onSubmit={handleSave} className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="fullName"
                      className="text-xs font-bold uppercase tracking-wider text-brand-on-surface-variant/80"
                    >
                      Họ và tên
                    </label>
                    <Input
                      ...
                      className="h-11 rounded-xl border-brand-outline-variant/30 bg-brand-surface-container-lowest/60 text-brand-on-surface focus-visible:border-brand-tertiary focus-visible:ring-brand-tertiary/30"
                  ...
                  {/* Email (Disabled) */}
                  <div className="space-y-2">
                    <label className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand-on-surface-variant/60">
                      Địa chỉ Email
                      <span className="text-[10px] font-normal lowercase text-brand-on-surface-variant/40">
                        (không thể thay đổi)
                      </span>
                    </label>
                    <Input
                      ...
                      disabled
                      value={profile?.email || ''}
                      className="h-11 cursor-not-allowed rounded-xl border-brand-outline-variant/15 bg-white/[0.02] text-brand-on-surface-variant/60 opacity-60"
                    />
                  </div>

                  <div className="my-6 space-y-4 border-t border-brand-outline-variant/10 pt-6">
                    <h4 className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand-secondary">
                ...
                <div className="flex justify-end border-t border-brand-outline-variant/10 pt-4">
                  <Button
                    type="submit"
                    disabled={isSaving || !fullName.trim()}
                    className="h-11 gap-2 rounded-xl bg-gradient-to-r from-brand-primary to-brand-tertiary px-6 font-semibold text-white shadow-md transition-all hover:-translate-y-0.5"
                  >
                    {isSaving ? (
                      <>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card relative overflow-hidden rounded-2xl border border-brand-outline-variant/20 bg-brand-surface-container/40 p-6 shadow-xl">
              ...
              <div className="mt-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={`rounded-xl bg-gradient-to-br p-2.5 ${getPlanGradient(profile?.subscriptionPlan)} shrink-0 shadow-md`}
                  >
                    <Zap className="h-5 w-5" />
                  </div>
                  <div>
                    <h4 className="text-base font-extrabold uppercase tracking-wide text-brand-on-surface">
              ...
              <div className="mt-6 space-y-3 border-t border-brand-outline-variant/10 pt-4">
                <div className="flex items-center justify-between text-xs">
                  <span className="flex items-center gap-1 text-brand-on-surface-variant/70">
              ...
              {false && profile?.subscriptionPlan === 'free' && (
                <div className="mt-6">
                  <Link href="/pricing" className="w-full">
                    <Button className="w-full gap-2 bg-gradient-to-r from-brand-secondary to-amber-500 text-xs font-semibold text-black shadow-md transition-all hover:-translate-y-0.5">
            ...
            <div className="glass-card rounded-2xl border border-brand-outline-variant/20 bg-brand-surface-container/20 p-6">
              <h3 className="border-b border-brand-outline-variant/10 pb-3 text-xs font-bold uppercase tracking-wider text-brand-on-surface-variant/80">
                Thông tin hệ thống
              </h3>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-wider text-brand-on-surface-variant/60">
                      Quyền hạn
                    </p>
                    <span
