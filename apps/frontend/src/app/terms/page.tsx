      ...
      <main className="relative pb-24 pt-32">
        ...
        <Container className="relative z-10 max-w-4xl">
          ...
          <div className="mb-12 text-center md:text-left">
            ...
            <div className="mt-3 flex items-center justify-center gap-2 text-sm text-brand-on-surface-variant md:justify-start">
          ...
          {/* Main Card */}
          <div className="glass-card rounded-2xl border border-brand-tertiary/15 p-6 shadow-2xl shadow-brand-tertiary/5 md:p-12">
            <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed text-brand-on-surface-variant md:text-base">
              <p className="font-medium text-brand-on-surface/90">
                Chào mừng bạn đến với <strong>iLaw – Bạn đồng hành pháp luật</strong>. Điều khoản sử
                dụng này quy định các quyền và nghĩa vụ của người dùng khi truy cập và sử dụng
                website{' '}
                <a href="http://ilaw.io.vn" className="text-brand-tertiary hover:underline">
                  ilaw.io.vn
                </a>
                .
              </p>
              <p className="font-medium text-brand-on-surface/90">
                Bằng việc truy cập, đăng ký tài khoản hoặc sử dụng bất kỳ dịch vụ nào của iLaw, bạn
                xác nhận đã đọc, hiểu và đồng ý tuân thủ các điều khoản dưới đây.
              </p>

              <div className="my-8 h-px bg-brand-outline-variant/10" />
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-1 border-l-2 border-brand-tertiary/30 pl-4">
                  <p>
                    <strong>Tên thương hiệu:</strong> iLaw – Bạn đồng hành pháp luật
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Đơn vị vận hành:</strong> iLaw là dự án do nhóm khởi nghiệp vận hành
                  </p>
                  <p>
              ...
              <section className="space-y-3">
                ...
                <p>
                  iLaw cung cấp các dịch vụ hỗ trợ pháp lý bằng công nghệ AI, bao gồm nhưng không
                  giới hạn:
                </p>
                ...
                <p className="text-xs italic text-brand-on-surface-variant/80">
                  Chúng tôi có quyền bổ sung, thay đổi hoặc ngừng cung cấp một phần hoặc toàn bộ
                  dịch vụ mà không cần thông báo trước.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  Để sử dụng một số tính năng, người dùng có thể cần đăng ký tài khoản thông qua:
                </p>
                <ul className="list-disc space-y-1 pl-6">
                ...
                <p className="text-xs font-medium text-amber-400/80">
                  Nếu phát hiện hành vi vi phạm, iLaw có quyền khóa hoặc chấm dứt tài khoản mà không
                  cần báo trước.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-2 rounded-xl border border-amber-500/25 bg-amber-500/5 p-4 text-brand-on-surface/90">
                  ...
                  <ul className="list-decimal space-y-1 pl-5 text-sm text-brand-on-surface-variant">
                    ...
                    <li>
                      Nội dung AI không thay thế luật sư, chuyên gia pháp lý hoặc cơ quan nhà nước
                      có thẩm quyền.
                    </li>
                  </ul>
                  <p className="mt-2 text-xs font-medium text-brand-on-surface">
                    Người dùng có trách nhiệm tự xác minh thông tin trước khi áp dụng vào thực tế.
                  </p>
                </div>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  iLaw có thể cung cấp tính năng kết nối người dùng với luật sư hoặc chuyên gia pháp
                ...
                <ul className="list-disc space-y-1 pl-6">
                  ...
                  <li>
                    iLaw không chịu trách nhiệm đối với nội dung tư vấn hoặc thỏa thuận giữa các
                    bên.
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p className="text-xs font-medium text-red-400/80">
                  Mọi hành vi vi phạm có thể dẫn đến việc khóa tài khoản và báo cáo cho cơ quan có
              ...
              <section className="space-y-3">
                ...
                <p>
                  đều thuộc quyền sở hữu của iLaw hoặc các bên cấp phép hợp pháp. Người dùng không
                  được sao chép, chỉnh sửa, phân phối hoặc khai thác thương mại khi chưa có sự đồng
                  ý bằng văn bản của iLaw.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  Khi sử dụng dịch vụ, người dùng đồng ý cho phép iLaw thu thập và xử lý các thông
                  tin cần thiết như:
                </p>
                <ul className="list-disc space-y-1 pl-6">
              ...
              <section className="space-y-3">
                ...
                <div className="my-2 grid grid-cols-2 gap-2 sm:grid-cols-4">
                  {['Miễn phí', 'Cơ bản', 'Pro', 'Cao cấp'].map((tier) => (
                    <div
                      key={tier}
                      className="rounded-lg border border-brand-outline-variant/20 bg-white/[0.02] p-3 text-center text-sm font-medium text-brand-on-surface"
                    >
                      {tier}
                    </div>
                  ))}
                ...
                <p>
                  Mức giá, quyền lợi và điều kiện sử dụng của từng gói sẽ được công bố chính thức
                  trên website tại từng thời điểm. Người dùng có trách nhiệm thanh toán đầy đủ các
                  khoản phí trước khi sử dụng các tính năng trả phí.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p className="text-xs font-medium italic text-brand-on-surface">
                  Người dùng tự chịu trách nhiệm đối với các quyết định được đưa ra dựa trên thông
                  tin từ nền tảng.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <ul className="list-disc space-y-1 pl-6">
                  ...
                  <li>
                    Khóa hoặc chấm dứt tài khoản vi phạm điều khoản sử dụng mà không phát sinh nghĩa
                    vụ bồi thường trong phạm vi pháp luật cho phép.
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  iLaw có quyền cập nhật hoặc sửa đổi Điều khoản sử dụng bất kỳ lúc nào. Phiên bản
                  mới sẽ được đăng tải trên website và có hiệu lực kể từ thời điểm công bố. Việc
                  tiếp tục sử dụng dịch vụ sau khi điều khoản được cập nhật đồng nghĩa với việc
                  người dùng chấp nhận các thay đổi đó.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  Điều khoản sử dụng này được điều chỉnh và giải thích theo pháp luật nước Cộng hòa
                  Xã hội Chủ nghĩa Việt Nam.
                </p>
                <p>
                  Mọi tranh chấp phát sinh liên quan đến việc sử dụng dịch vụ sẽ được ưu tiên giải
                  quyết thông qua thương lượng. Trường hợp không thể giải quyết bằng thương lượng,
                  tranh chấp sẽ được đưa ra tòa án có thẩm quyền tại Việt Nam theo quy định của pháp
                  luật.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-1 border-l-2 border-brand-tertiary/30 pl-4 text-sm">
                  <p>
                    <strong>iLaw – Bạn đồng hành pháp luật</strong>
                  </p>
                  <p>
                    <strong>Website:</strong>{' '}
                    <a href="http://ilaw.io.vn" className="text-brand-tertiary hover:underline">
              ...
              <p className="text-center text-xs font-medium text-brand-on-surface-variant">
                Khi sử dụng website ilaw.io.vn, người dùng xác nhận đã đọc, hiểu và đồng ý với toàn
                bộ Điều khoản sử dụng này.
              </p>
            </div>
          </div>
        </Container>
